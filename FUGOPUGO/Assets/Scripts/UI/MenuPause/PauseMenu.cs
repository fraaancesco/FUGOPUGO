...
public class PauseMenu : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKeyDown(InputManager.Instance.controls["pause"]) && !GameManager.GetComponent<GameManager>().gameHasEnded && !GameManager.GetComponent<GameManager>().stopGame) 
        {
            isPaused = !isPaused;
        }
